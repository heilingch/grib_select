# GRIB Select (grib_select)

GRIB file based weather model verification tool to suggest which forecast model will be most accurate in the near future. 
...
To use GRIB Select, you must install the required Python packages. 
...
*(Note: `cfgrib` and `eccodes` usually require system-level eccodes libraries on most operating systems. If you run into installation issues, please refer to the [cfgrib documentation](https://github.com/ecmwf/cfgrib).)*
